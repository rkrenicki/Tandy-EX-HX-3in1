...
NoConn ~ 7750 5450
$Comp
L 3-in-1-rescue:74LS138-isa_fdc-rescue 232-U?
U 1 1 5DCD9038
P 7150 5200
...
$EndComp
$Comp
L 3-in-1-rescue:16550-PLCC-isa_fdc-rescue 232-U8
U 1 1 5DCD903E
P 7650 2900
...
NoConn ~ 8450 2550
$Comp
L 3-in-1-rescue:DB9-isa_fdc-rescue 232-P?
U 1 1 5DCD904B
P 11700 3350
...
NoConn ~ 9450 1750
$Comp
L 3-in-1-rescue:74LS688-xt-cf-rescue CF-U2
U 1 1 5DCF5A5A
P 2200 8150
...
Wire Wire Line
	7950 8300 7750 8300
$Comp
L 3-in-1-rescue:28C64-xt-cf-rescue ROM-U5
U 1 1 5DCF5ABC
P 10600 8250
...
BIOS ROM (0xC000)
$Comp
L 3-in-1-rescue:74LS688-xt-cf-rescue ROM-U4
U 1 1 5DCF5AC3
P 8550 8300
...
Wire Wire Line
	7850 8800 7850 8900
$Comp
L 3-in-1-rescue:R-xt-cf-rescue R?
U 1 1 5DCF5AE8
P 5150 8200
...
$Comp
L 3-in-1-rescue:C-isa_fdc-rescue C?
U 1 1 5DD23250
P 14900 1600
...
NoConn ~ 15000 6250
$Comp
L xt-cf-rescue:TANDY_BUS BUS1
U 1 1 5DD232FD
P 14450 7450
AR Path="/5DD232FD" Ref="BUS1"  Part="1" 
AR Path="/5DB9D5BF/5DD232FD" Ref="BUS?"  Part="1" 
AR Path="/5DBF6E56/5DD232FD" Ref="BUS?"  Part="1" 
F 0 "BUS1" H 14450 9260 70  0000 C CNN
F 1 "TANDY_BUS" H 14450 9139 70  0000 C CNN
F 2 "Tandy-IO:TANDY-PLUS-BUS" H 14450 7450 50  0001 C CNN
...
F 0 "#PWR0143" H 15000 8700 50  0001 C CNN
...
F 0 "#PWR0144" H 15000 6600 50  0001 C CNN
...
F 0 "#PWR0145" H 15000 5700 50  0001 C CNN
F 1 "GND" V 15005 5822 50  0000 R CNN
F 2 "" H 15000 5950 50  0001 C CNN
F 3 "" H 15000 5950 50  0001 C CNN
	1    15000 5950
	0    -1   -1   0   
$EndComp
Text Notes 13750 5500 0    120  ~ 0
Tandy PLUS Bus
Text GLabel 15000 6950 2    50   Input ~ 0
~MEMW
Text GLabel 15000 7050 2    50   Input ~ 0
~MEMR
Text GLabel 15000 7150 2    50   Input ~ 0
~IOW
...
F 0 "#PWR0146" H 15000 6650 50  0001 C CNN
F 1 "-12V" V 15015 6678 50  0000 L CNN
...
F 0 "#PWR0147" H 15000 6600 50  0001 C CNN
F 1 "+12V" V 15015 6878 50  0000 L CNN
...
A11
Text GLabel 13550 7950 0    50   Input ~ 0
A10
Text GLabel 13550 8050 0    50   Input ~ 0
A9
Text GLabel 13550 8150 0    50   Input ~ 0
A8
...
A5
Text GLabel 13550 8550 0    50   Input ~ 0
A4
...
A1
Text GLabel 13550 8950 0    50   Input ~ 0
A0
$Comp
L power:+5V #PWR?
U 1 1 5DD23344
...
F 0 "#PWR0151" H 15000 6000 50  0001 C CNN
F 1 "+5V" V 15015 6278 50  0000 L CNN
...
$Comp
L 3-in-1-rescue:GD75232-isa_fdc-rescue 232-U?
U 1 1 5DCD9096
P 10150 3400
...
$EndComp
Wire Notes Line
	13000 5250 15950 5250
Wire Notes Line
	15950 5250 15950 9200
Wire Notes Line
	15950 9200 13000 9200
Wire Notes Line
	13000 9200 13000 5250
Wire Notes Line
	12500 800  16300 800 
Wire Notes Line
...
U 1 1 5E709C41
P 15000 8750
F 0 "#PWR0159" H 15000 8600 50  0001 C CNN
F 1 "+5V" V 15015 8878 50  0000 L CNN
